...
public class PrettyPrintVisitor extends Visitor
{
    ...
    public PrettyPrintVisitor(boolean printLinks, boolean printTypes, 
                              PrintStream ps)
    {
    ...
    {
        tab();
        String xtn = n.breakLink != null && printLinks() ? 
                       "@"+n.breakLink.uniqueId : "";
    ...
    {
        String xtn = n.methodLink != null && printLinks() ? 
                        "@"+n.methodLink.uniqueId : "";
        print(n.obj);
    ...
    public Object visit(ClassDecl n)
    {
        ...
        if (printLinks())
        {
            String xtnStr = n.superLink == null ? 
                             "" : "@"+n.superLink.uniqueId;
            ps.println("class "+n.name+"#"+n.uniqueId+" extends "
                               +n.superName+xtnStr+" {");
        }
        else
        {
    ...
    {
        print(n.exp);
        String xtn = n.varDec != null && printLinks() ?
                         "@"+n.varDec.uniqueId : "";
